...
/* Create a modifer that checks if the msg.sender is the owner of the contract */
  modifier isOwner() { msg.sender == owner; _; }
  modifier verifyCaller(address _address) { require(msg.sender == _address, "Caller is not buyer or seller"); _;}

  modifier paidEnough(uint _price) { require(msg.value >= _price, "You haven't sent enough funds"); _; }
